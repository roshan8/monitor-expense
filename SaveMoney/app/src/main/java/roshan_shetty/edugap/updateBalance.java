...
public class updateBalance extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        postTextTitle.setHint("How much money you want to deposit");
        postTextContent.setHint("note");
    ...
    public void sendStatusDude() {
        ...
        updateBalanceLabel();
        saveToTable("Deposit : " + expense, purpose, postedTime);
    ...
    public void saveToTable(String expense, String purpose, String postedTime) {//(String msgTitle, String msgContent, String msgType, String postedTime, String postedBy) {
        ...
        Log.d("Save", "Update SQLite table");
